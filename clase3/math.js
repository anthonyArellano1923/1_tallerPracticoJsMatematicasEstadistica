...
//   sides.sort((x, y) => y - x);
//   let [bigSideC, middleSideB, littleSideA] = sides;
  
//   if (![bigSideC, middleSideB, littleSideA].every(side => typeof side === 'number' && side > 0)) {
//     throw new Error('Los lados deben ser números, mayores que 0')
//   }

//   if ( bigSideC != middleSideB && middleSideB != littleSideA && littleSideA != bigSideC && (middleSideB + littleSideA > bigSideC)) {
//     return {
//       scaleneTriangleHeight : Number(Math.sqrt( (middleSideB ** 2) - (((middleSideB ** 2 + bigSideC ** 2 - littleSideA ** 2) ** 2) / (4 * (bigSideC ** 2)))).toFixed(0))
//     }
//   }
//   else {
//     throw new Error('El triangulo escaleno debe tener todos sus lados diferentes y la suma de sus lados más pequeños debe ser mayor al lado más grande.');
//   }
// }
